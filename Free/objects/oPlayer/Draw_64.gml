...
draw_sprite_stretched(sHealthBarLifesteal, 0, healthbar_x, healthbar_y, ((global.playerHP + attacksInARow/gainHealthAfterAttacks)/global.playerMaxHP)*healthbar_width, healthbar_height);
